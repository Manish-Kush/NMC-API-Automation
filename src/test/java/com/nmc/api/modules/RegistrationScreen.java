...
public class RegistrationScreen extends BaseClass
{
	 ...
	 String xlPath = "/home/manish/Desktop/ReportFromRepository/NMC-API-Automation/src/test/java/com/nmc/api/testdata/Locators.xlsx";
	...
	{
		String locator = XLUtils.getCellData(xlPath, "Registration", row, column);
		webElementName=XLUtils.getCellData(xlPath, "Registration", row, column-2);
		return locator;	
	}
	
	public String getData(int row, int column) throws IOException
	{
		return XLUtils.getCellData(xlDataPath,"Sheet1", row, column);
	}
	 ...
	 */
	public boolean opRegistration() throws IOException, InterruptedException
		{
			...
			//Adding Patient Addational Information
			  ...
			  BaseClass.logger.info(webElementName+" Is entered");
			  CommonActionUtils.sendKeysById(getLocator(59, 3), getData(2, 35),driver);
			  BaseClass.logger.info(webElementName+" Is entered");
 ...
 * 
 */
	public boolean ospRegistration() throws IOException, InterruptedException
	 {
...
//	    BaseClass.logger.info("Clicked on "+webElementName);
		...
		CommonActionUtils.sendKeysById(getLocator(184, 3), getData(2, 34),driver);
	     ...
	     System.out.println("Title after selecting diag type "+driver.getTitle());
	     ...
	     try {
			     ...
			     robot.keyPress(KeyEvent.VK_ENTER);
			     robot.keyRelease(KeyEvent.VK_ENTER);
			     BaseClass.logger.info("successfully entered and selected Diagnostic Code. WebElement name is : "+webElementName);
	     ...
	     {
	    	 robot.keyPress(KeyEvent.VK_ENTER);
	    	 System.out.println("clearing the code text...");
	    	 robot.keyRelease(KeyEvent.VK_ENTER);
...
//	    	 System.out.println("enter key got released...");
	...
	public boolean preRegistration() throws IOException, InterruptedException
	{
		writeExel.writeUniqueFieldsIntoExcel();//Write unique name, phone number & old reg number into excel file
		
		CommonActionUtils.selectDropdownByName(getLocator(201,3), getData(2, 47), driver);
		BaseClass.logger.info("successfully change center to NMCAbuDhabi and webelement name is "+webElementName);
